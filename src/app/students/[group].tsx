    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-4 w-full mt-5">
            ...
            <div className="w-full max-w-6xl flex items-center justify-center">
                <input type="text" placeholder="Search" className="w-full max-w-6xl p-2 rounded-lg bg-gray-900 text-white" />
                <button className="bg-blue-900 text-white px-4 py-2 rounded-lg">Search</button>
                    <button className="bg-blue-900 text-white px-4 py-2 rounded-lg">Search</button>
                <div className="w-full max-w-6xl flex items-center justify-center">
                    <select 
                        name="group" 
